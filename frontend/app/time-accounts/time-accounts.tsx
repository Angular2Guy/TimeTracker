            ...
            onKeyDown={(event) => {
              if (event.key === "Enter") {
                ...
                if (selectedUser) {
                  ...
                  if (mySelectedRow) {
                    const userIds = mySelectedRow.userIds
                      ? mySelectedRow.userIds
                      : [];
                    mySelectedRow.userIds = userIds
                      .filter((id) => id !== selectedUser.id)
                      .concat(selectedUser.id);
          ...
          >
            {selectedUsers.map((user) => (
              <ListItem key={user.id}>
                ...
                <ListItemAvatar>
                  <CloseIcon
                    onClick={() => removeUserFromSelectedUsers(user)}
                  />
                </ListItemAvatar>
              </ListItem>
            ))}
